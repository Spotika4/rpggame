# RPG by Spotika4
RPG на базе Phaser3. В качестве окружения используется Parcel Template.

> Проект для практики JS. В качестве картинок используется графика из RPG Maker MV. В случае необходимости, через настройки проекта, можно подключить другую графику
